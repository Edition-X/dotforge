...
def load_script(name: str, filename: str) -> ModuleType:
    ...
    if spec is None or spec.loader is None:
        raise RuntimeError("automation smoke module could not be loaded")
...
AUTOMATION = load_script("browser_git_automation", "browser-git-automation.py")
...
def seed_source(root: Path) -> Path:
    ...
    git(source, "add", "--", "scripts", "host_files", "Brewfile")
